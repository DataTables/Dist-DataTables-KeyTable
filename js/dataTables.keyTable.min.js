...
f(c.target).parents("div.editor-datetime").length||f(c.target).parents().filter(".DTFC_Cloned").length||a._blur()});if(this.c.editor){var d=this.c.editor;d.on("open.keyTableMain",function(b,c){"inline"!==c&&a.s.enable&&(a.enable(!1),d.one("close.keyTable",function(){a.enable(!0)}))});b.on("key.keyTable",function(b,c,d,e,f){a._editor(d,f,!1)});f(b.table().body()).on("dblclick.keyTable","th, td",function(c){!1!==a.s.enable&&b.cell(this).any()&&a._editor(null,c,!0)})}if(b.settings()[0].oFeatures.bStateSave)b.on("stateSaveParams.keyTable",
...
g).submit():(d.cell.data(g),a.draw(!1))}))},_columns:function(){var a=this.s.dt,b=a.columns(this.c.columns).indexes(),c=[];a.columns(":visible").every(function(a){-1!==b.indexOf(a)&&c.push(a)});return c},_editor:function(a,b,c){var d=this.s.dt,e=this.c.editor,l=this.s.lastFocus.cell;if(!f("div.DTE",l.node()).length&&!(null!==a&&(0<=a&&9>=a||11===a||12===a||14<=a&&31>=a||112<=a&&123>=a||127<=a&&159>=a))){b.stopPropagation();13===a&&b.preventDefault();var g=function(){e.one("open.keyTable",function(){e.off("cancelOpen.keyTable");
c||f("div.DTE_Field_InputControl input, div.DTE_Field_InputControl textarea").select();d.keys.enable(c?"tab-only":"navigation-only");d.one("key-blur.editor",function(){e.displayed()&&e.submit()});c&&f(l.node()).addClass("focus-alt");e.one("close",function(){d.keys.enable(!0);d.off("key-blur.editor");f(l.node()).removeClass("focus-alt")})}).one("cancelOpen.keyTable",function(){e.off("open.keyTable")}).inline(l.index())};13===a?(c=!0,f(h).one("keyup",function(){g()})):g()}},_emitEvent:function(a,b){this.s.dt.iterator("table",
function(c){f(c.nTable).triggerHandler(a,b)})},_focus:function(a,b,c,d){var e=this,l=this.s.dt,g=l.page.info(),i=this.s.lastFocus;d||(d=null);if(this.s.enable){if("number"!==typeof a){if(!a.any())return;var j=a.index(),b=j.column,a=l.rows({filter:"applied",order:"applied"}).indexes().indexOf(j.row);g.serverSide&&(a+=g.start)}if(-1!==g.length&&(a<g.start||a>=g.start+g.length))this.s.focusDraw=!0,this.s.waitingForDraw=!0,l.one("draw",function(){e.s.focusDraw=!1;e.s.waitingForDraw=!1;e._focus(a,b,o,
d)}).page(Math.floor(a/g.length)).draw(!1);else if(-1!==f.inArray(b,this._columns())){g.serverSide&&(a-=g.start);g=l.cells(null,b,{search:"applied",order:"applied"}).flatten();g=l.cell(g[a]);if(i){if(i.node===g.node()){this._emitEvent("key-refocus",[this.s.dt,g,d||null]);return}this._blur()}i=f(g.node());i.addClass(this.c.className);this._updateFixedColumns(b);if(c===o||!0===c)this._scroll(f(k),f(h.body),i,"offset"),c=l.table().body().parentNode,c!==l.table().header().parentNode&&(c=f(c.parentNode),
this._scroll(c,c,i,"position"));this.s.lastFocus={cell:g,node:g.node(),relative:{row:l.rows({page:"current"}).indexes().indexOf(g.index().row),column:g.index().column}};this._emitEvent("key-focus",[this.s.dt,g,d||null]);l.state.save()}}},_key:function(a){if(this.s.waitingForDraw)a.preventDefault();else{var b=this.s.enable,c=!0===b||"navigation-only"===b;if(b&&(!(0===a.keyCode||a.ctrlKey||a.metaKey||a.altKey)||a.ctrlKey&&a.altKey)&&this.s.lastFocus){var d=this.s.dt,e=this.s.dt.settings()[0].oScroll.sY?
!0:!1;if(!(this.c.keys&&-1===f.inArray(a.keyCode,this.c.keys)))switch(a.keyCode){case 9:this._shift(a,a.shiftKey?"left":"right",!0);break;case 27:this.s.blurable&&!0===b&&this._blur();break;case 33:case 34:c&&!e&&(a.preventDefault(),d.page(33===a.keyCode?"previous":"next").draw(!1));break;case 35:case 36:c&&(a.preventDefault(),b=d.cells({page:"current"}).indexes(),c=this._columns(),this._focus(d.cell(b[35===a.keyCode?b.length-1:c[0]]),null,!0,a));break;case 37:c&&this._shift(a,"left");break;case 38:c&&
...
this.s.dt,c=b.settings()[0];if(c._oFixedColumns){var d=c.aoColumns.length-c._oFixedColumns.s.iRightColumns;(a<c._oFixedColumns.s.iLeftColumns||a>=d)&&b.fixedColumns().update()}}});n.defaults={blurable:!0,className:"focus",clipboard:!0,clipboardOrthogonal:"display",columns:"",editor:null,focus:null,keys:null,tabIndex:null};n.version="2.5.0-dev";f.fn.dataTable.KeyTable=n;f.fn.DataTable.KeyTable=n;m.Api.register("cell.blur()",function(){return this.iterator("table",function(a){a.keytable&&a.keytable.blur()})});
