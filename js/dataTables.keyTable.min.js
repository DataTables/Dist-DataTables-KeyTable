...
function(){c.displayed()&&c.submit()});c.one("close",function(){d.keys.enable(!0);d.off("key-blur.editor")})},_emitEvent:function(a,b){this.s.dt.iterator("table",function(d){e(d.nTable).triggerHandler(a,b)})},_focus:function(a,b){var d=this,c=this.s.dt,f=c.page.info(),m=this.s.lastFocus;if(this.s.enable){if("number"!==typeof a){var h=a.index(),b=h.column,a=c.rows({filter:"applied",order:"applied"}).indexes().indexOf(h.row);f.serverSide&&(a+=f.start)}if(-1!==f.length&&(a<f.start||a>=f.start+f.length))c.one("draw",
function(){d._focus(a,b)}).page(Math.floor(a/f.length)).draw(!1);else if(-1!==e.inArray(b,this._columns())){f.serverSide&&(a-=f.start);f=c.cell(":eq("+a+")",b,{search:"applied"});if(m){if(m.node()===f.node())return;this._blur()}m=e(f.node());m.addClass(this.c.className);this._scroll(e(k),e(j.body),m,"offset");h=c.table().body().parentNode;h!==c.table().header().parentNode&&(h=e(h.parentNode),this._scroll(h,h,m,"position"));this.s.lastFocus=f;this._emitEvent("key-focus",[this.s.dt,f]);c.state.save()}}},
_key:function(a){if(this.s.enable&&!(0===a.keyCode||a.ctrlKey||a.metaKey||a.altKey)){var b=this.s.lastFocus;if(b){var d=this,c=this.s.dt;if(!(this.c.keys&&-1===e.inArray(a.keyCode,this.c.keys)))switch(a.keyCode){case 9:this._shift(a,a.shiftKey?"left":"right",!0);break;case 27:this.s.blurable&&!0===this.s.enable&&this._blur();break;case 33:case 34:a.preventDefault();var f=c.cells({page:"current"}).nodes().indexOf(b.node());c.one("draw",function(){var a=c.cells({page:"current"}).nodes();d._focus(c.cell(f<
a.length?a[f]:a[a.length-1]))}).page(33===a.keyCode?"previous":"next").draw(!1);break;case 35:case 36:a.preventDefault();b=c.cells({page:"current"}).indexes();this._focus(c.cell(b[35===a.keyCode?b.length-1:0]));break;case 37:this._shift(a,"left");break;case 38:this._shift(a,"up");break;case 39:this._shift(a,"right");break;case 40:this._shift(a,"down");break;default:!0===this.s.enable&&this._emitEvent("key",[c,a.keyCode,this.s.lastFocus,a])}}}},_scroll:function(a,b,d,c){var c=d[c](),f=d.outerHeight(),
d=d.outerWidth(),e=b.scrollTop(),h=b.scrollLeft(),i=a.height(),a=a.width();c.top<e&&b.scrollTop(c.top);c.left<h&&b.scrollLeft(c.left);c.top+f>e+i&&b.scrollTop(c.top+f-i);c.left+d>h+a&&b.scrollLeft(c.left+d-a)},_shift:function(a,b,d){var c=this.s.dt,f=c.page.info(),j=f.recordsDisplay,h=this.s.lastFocus,i=this._columns();if(h){var g=c.rows({filter:"applied",order:"applied"}).indexes().indexOf(h.index().row);f.serverSide&&(g+=f.start);c=c.columns(i).indexes().indexOf(h.index().column);f=i[c];"right"===
b?c>=i.length-1?(g++,f=i[0]):f=i[c+1]:"left"===b?0===c?(g--,f=i[i.length-1]):f=i[c-1]:"up"===b?g--:"down"===b&&g++;0<=g&&g<j&&-1!==e.inArray(f,i)?(a.preventDefault(),this._focus(g,f)):!d||!this.c.blurable?a.preventDefault():this._blur()}},_tabInput:function(){var a=this,b=this.s.dt,d=null!==this.c.tabIndex?this.c.tabIndex:b.settings()[0].iTabIndex;if(-1!=d)e('<div><input type="text" tabindex="'+d+'"/></div>').css({position:"absolute",height:1,width:0,overflow:"hidden"}).insertBefore(b.table().node()).children().on("focus",
function(){a._focus(b.cell(":eq(0)",{page:"current"}))})}});l.defaults={blurable:!0,className:"focus",columns:"",editor:null,focus:null,keys:null,tabIndex:null};l.version="2.1.1-dev";e.fn.dataTable.KeyTable=l;e.fn.DataTable.KeyTable=l;g.Api.register("cell.blur()",function(){return this.iterator("table",function(a){a.keytable&&a.keytable.blur()})});g.Api.register("cell().focus()",function(){return this.iterator("cell",function(a,b,d){a.keytable&&a.keytable.focus(b,d)})});g.Api.register("keys.disable()",
...
c=g.defaults.keys;if(d||c)c=e.extend({},d,c),!1!==d&&new l(b,c)}});return l});
